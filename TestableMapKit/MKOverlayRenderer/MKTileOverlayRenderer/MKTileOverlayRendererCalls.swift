//
//  MKTileOverlayRendererCalls.swift
//  TestableMapKit
//
...
public extension MKTileOverlayRenderer {
...
extension MKTileOverlayRenderer: ShimMethodForwarding {

    /*!
        The MKTileOverlayRenderer shim should not forward spied messages by default.
    */
